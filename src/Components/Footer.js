...
const Footer = () => {
  ...
  return (
    <div className="nav-bar">
      ...
      <Link className="sound-button" to="/apps" onClick={playClickSound}><p>Projects</p></Link>
      <Link className="sound-button" to="/projects" onClick={playClickSound}><p>Gallery</p></Link>
